    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(choices=[('male', 'Masculino'), ('female', 'Femenino')], default='male',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pvp',
                 models.DecimalField(decimal_places=2, default=0.0, max_digits=9, verbose_name='Precio de venta')),
                ('cat', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='erp.Category',
